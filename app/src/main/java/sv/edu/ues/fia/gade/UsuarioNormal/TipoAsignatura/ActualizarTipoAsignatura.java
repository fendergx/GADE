...
public class ActualizarTipoAsignatura extends AppCompatActivity {
    EditText nombre,id;
    controlDB myDb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actualizar_tipo_asignatura);
        myDb = new controlDB(this);
        final String valor = getIntent().getExtras().getString("Value");
        Cursor cursor = myDb.buscar("TIPOASIGNATURA",valor,"ID");
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                int delete = myDb.deleteDataTipoAsignatura(valor);
    ...
    private void ClickMe(String id){
        ...
        if(!num.isEmpty()){
            Boolean result = myDb.updateDataTipoAsignatura(id,num);
            if (result == true){
            ...
            Funciones.showAlert(this,"Guardar Tipo","No puede tener campos vacíos");
        }
